...
public struct ChatTheme {
    ...
    public struct Colors {
        ...
        public init(
            ...
            buttonBackground: Color = Color(hex: "000000"),
            addButtonBackground: Color = Color(hex: "#4F5055"),
            sendButtonBackground: Color = Color(hex: "#000000"),
            messageMenuBackground: Color = Color.white,
            myMessage: Color = Color(hex: "#F7CFE8"),
            friendMessage: Color = Color(hex: "#282828"),
